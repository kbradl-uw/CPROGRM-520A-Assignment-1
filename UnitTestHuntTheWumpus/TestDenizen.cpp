...
namespace TestHuntTheWumpus
{
    ...
    {
        constexpr HuntTheWumpus::DenizenIdentifier thing1 { HuntTheWumpus::Category::Wumpus, 0 };  // Wumpus == 0 
        constexpr HuntTheWumpus::DenizenIdentifier thing2 { HuntTheWumpus::Category::Arrow, 0 };   // Arrow == 4
        constexpr HuntTheWumpus::DenizenIdentifier thing3 { HuntTheWumpus::Category::Arrow, 1 };
